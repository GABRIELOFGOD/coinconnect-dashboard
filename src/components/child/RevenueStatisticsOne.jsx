...
const RevenueStatisticsOne = () => {
  let { upDownBarChartSeries, upDownBarChartOptions } = useReactApexChart(); {/* Worked in here */}
  return (
      ...
      <div className='card h-100 radius-8 border-0'>
        <div className='card-body p-24'>
          ...
          <div className='mt-24 mb-24 d-flex flex-wrap'>
            <div className='me-40'>
              <span className='text-secondary-light text-sm mb-1'>Deposit</span> {/* Incone changed to Deposit */}
              <div className=''>
            ...
            <div>
              <span className='text-secondary-light text-sm mb-1'>
                Withdrawal {/* Expenses changed to Withdrawal */}
              </span>
              <div className=''>
